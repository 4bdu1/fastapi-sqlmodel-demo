...
description = """
fastapi_sqlmodel_demo API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://fastapi_sqlmodel_demo.com/terms/",
    contact={
        "name": "4bdu1",
        "url": "http://fastapi_sqlmodel_demo.com/contact/",
        "email": "4bdu1@fastapi_sqlmodel_demo.com",
    },
    license_info={
        "name": "The Unlicense",
