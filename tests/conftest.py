...
# WARNING: Ensure imports from `fastapi_sqlmodel_demo` comes after this line
from fastapi_sqlmodel_demo import app, settings, db  # noqa
from fastapi_sqlmodel_demo.cli import create_user, cli  # noqa
